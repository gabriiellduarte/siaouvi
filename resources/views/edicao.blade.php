...
<body>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('ouvidoria.update', $manifestacao->id) }}" method="POST" enctype="multipart/form-data" class="ouvidoria-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="tel" id="contato" name="contato" class="form-input" required value="{{ $manifestacao->contato }}">
            </div>
